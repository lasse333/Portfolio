  ...
  return (
    <div>
      ...
      <div className="headline">
        ...
        <br />
        <p>Her er nogle eksempler på tidligere projekter jeg har lavet på Viden-Djurs under min uddannelse.</p>
      </div>
      ...
      <div className="Projekter">
        ...
        <div className="ProjekterBox">
          <div className="imgbox">
            <img className="img" src={ eksamensopgave } alt="Forside til Webudvikler eksamensopgave" />
          </div>
          <div className="textbox">
            <h3>STRØM-opgave</h3>
            <p>STRØM-opgaven var en eksamensopgave, som vi fik 5 dage til at lave i November 2022.
              <br />
              Opgaven gik ud på at vi skulle lave en hjemmeside, hvor det skal forestille et elektriker firma's egen hjemmeside.
              <br />
              Hvor man kan læse om hvem de er, hvilken service de kan give, en FAQ på ofte stillet spørgsmål, og nyheder fra firmaet.
            </p>
